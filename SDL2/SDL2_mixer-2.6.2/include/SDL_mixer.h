...
#include SDL2_INCLUDE_DIR_SDL_stdinc
#include SDL2_INCLUDE_DIR_SDL_rwops
#include SDL2_INCLUDE_DIR_SDL_audio
#include SDL2_INCLUDE_DIR_SDL_endian
#include SDL2_INCLUDE_DIR_VERSION
